...
public class MainActivity extends AppCompatActivity {
    ...
    private static final int NUM_TAB_PAGES = 3;

    private static int getSoftButtonsBarSizePort(android.app.Activity activity) {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // We will adjust the padding to account for the soft buttons if they're showing
